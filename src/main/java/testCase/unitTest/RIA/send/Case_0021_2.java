...
//        driver.get("https://twitter.com/login");
            ...
            String custDestAddress = map2.get("custDestAddress");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.inputReceiverAddress(custDestAddress);
            Thread.sleep(5000);

            if (SendPageStep_2.validateReceiverAddress().equals("")) {
                logger.debug("validateAddress no");
                dataProvider.setOutputData("#output", "ไม่สามารถกรอกตัวอักษรได้");
            } else {
                logger.debug("validateAddress yes");
