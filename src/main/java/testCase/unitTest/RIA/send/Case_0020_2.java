...
//        driver.get("https://twitter.com/login");
            ...
            String mname = map2.get("mname");
            String custDestLname2 = map2.get("custDestLname2");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.inputReceiverLName2(custDestLname2);
            Thread.sleep(1000);

            if (SendPageStep_2.validateReceiverLName2().equals("")) {
