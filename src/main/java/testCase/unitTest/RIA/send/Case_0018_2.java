...
//        driver.get("https://twitter.com/login");
            ...
            String custDestMname = map2.get("custDestMname");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.inputCustDestMname(custDestMname);
            Thread.sleep(1000);

            if (SendPageStep_2.validateCustDestMname().equals("")) {
