...
//            driver.get("https://10.50.16.116/RSS/#/login");
            ...
            String custDestMobilePhone = map2.get("custDestMobilePhone");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.inputCustDestMobilePhone(custDestMobilePhone);
            Thread.sleep(5000);

            if (SendPageStep_2.validateCustDestMobilePhone().equals("")) {
                logger.debug("validatecustDestMobilePhone no");
                dataProvider.setOutputData("#output", "ไม่สามารถกรอกตัวอักษรได้");
            } else {
                logger.debug("validatecustDestMobilePhone yes");
