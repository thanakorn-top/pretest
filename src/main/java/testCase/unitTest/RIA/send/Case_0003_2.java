...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            if (SendPageStep_1_1.checkWarnCalculate().equals("")) {
                dataProvider.setOutputData("#output", "");
            } else {
                dataProvider.setOutputData("#output", SendPageStep_1_1.checkWarnCalculate());
            }

            Thread.sleep(3000);
            SendPageStep_1_1.closeWaringBtnClick();
            Thread.sleep(3000);
