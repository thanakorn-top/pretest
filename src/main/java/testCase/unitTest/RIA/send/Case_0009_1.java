...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.clickDOBCalendar();
            Thread.sleep(1000);
            SendPageStep_2.clickDOBExitMonth();
            Thread.sleep(1000);
            SendPageStep_2.clickDOBExitYear();
            Thread.sleep(1000);
            SendPageStep_2.clickDOBYear();
            Thread.sleep(1000);
            SendPageStep_2.clickDOBMonth();
            Thread.sleep(1000);
            SendPageStep_2.clickDOBDay();
            Thread.sleep(1000);
