...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.clickDOECalendar();
            Thread.sleep(1000);
            SendPageStep_2.clickDOEExitMonth();
            Thread.sleep(1000);
            SendPageStep_2.clickDOEExitYear();
            Thread.sleep(1000);
            SendPageStep_2.clickDOEYearExp();
            Thread.sleep(1000);
            SendPageStep_2.clickDOEMonth();
            Thread.sleep(1000);
            SendPageStep_2.clickDOEDay();
            Thread.sleep(1000);

//            SendPageStep_2.inputDOB(DOB);
//            Thread.sleep(1000);
            ...
            String respVerify = SendPageStep_2_1.checkResponseVerifyDOE();
