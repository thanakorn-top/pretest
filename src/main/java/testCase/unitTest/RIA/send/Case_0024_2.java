...
//            driver.get("https://10.50.16.116/RSS/#/login");
            ...
            String destinationPrimaryContactCountryCode = map2.get("destinationPrimaryContactCountryCode");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.checkCif();
            Thread.sleep(1000);
            
                   SendPageStep_2.selectReceiver(receiver);
            Thread.sleep(1000);
            
            SendPageStep_2.inputDestinationPrimaryContactCountryCode(destinationPrimaryContactCountryCode);
            Thread.sleep(5000);

            if (SendPageStep_2.validateDestinationPrimaryContactCountryCode().equals("")) {
                logger.debug("validateSubDistrict no");
                dataProvider.setOutputData("#output", "ไม่สามารถกรอกตัวอักษรได้");
            } else {
                logger.debug("validateSubDistrict yes");
