...
//            Thread.sleep(2000);
            ...
            if(SendPageStep_2.checkVerifyReceiverBtn()){
                dataProvider.setOutputData("#output", "ไปยังขั้นตอนถัดไปได้");
            }else{
...
//            google.testSendKey();
//            if (typeSendMoney.equals("จำนวนเงินที่ส่งไม่รวมค่าธรรมเนียม")) {
//                if (SendPageStep_1.checkAmountWarn().equals("")) {
//                    dataProvider.setOutputData("#output", "");
//                } else {
//                    dataProvider.setOutputData("#output", "กรุณาระบุ : จำนวนเงินทั้งหมด");
//                }
//            } else {
//                if (SendPageStep_1.checkAmountWarn_1().equals("")) {
//                    dataProvider.setOutputData("#output", "");
//                } else {
//                    dataProvider.setOutputData("#output", "กรุณาระบุ : จำนวนเงินทั้งหมด");
//                }
