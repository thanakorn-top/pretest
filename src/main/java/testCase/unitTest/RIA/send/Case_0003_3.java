...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            Thread.sleep(5000);
            if (SendPageStep_1.checkSubmitStatus()) {
                dataProvider.setOutputData("#output", "สามารถกดปุ่มขั้นตอนถัดไปได้");
            } else {
                dataProvider.setOutputData("#output", "ไม่สามารถกดปุ่มขั้นต่อไปได้");
            }
            Thread.sleep(3000);
