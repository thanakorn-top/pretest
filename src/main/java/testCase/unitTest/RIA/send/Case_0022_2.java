...
//            driver.get("https://10.50.16.116/RSS/#/login");
            ...
            String custDestSubDistrict = map2.get("custDestSubDistrict");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            SendPageStep_2.inputReceiverSubDistrict(custDestSubDistrict);
            Thread.sleep(5000);

            if (SendPageStep_2.validateReceiverSubDistrict().equals("")) {
