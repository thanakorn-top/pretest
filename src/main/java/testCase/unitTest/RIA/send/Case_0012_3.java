...
//        driver.get("https://twitter.com/login");
            ...
            String phoneNo = map2.get("phoneNo");
...
//            MainSendPage sendpage1 = PageFactory.initElements(driver, MainSendPage.class);
            ...
            Thread.sleep(1000);
            SendPageStep_2.inputPhoneNo(phoneNo);
            Thread.sleep(1000);
            ...
            String respVerify = SendPageStep_2_1.checkResponseVerifyPhoneNo();
