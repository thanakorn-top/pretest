...
//        driver.get("https://twitter.com/login");
            ...
            String reasonForCancel = map1.get("reasonForCancel");
...
//            loginpage.setId("KussakornA");
            ...
            Thread.sleep(2000);
            cancelPage.findTransaction();
            Thread.sleep(12000);

            CancelTransaction cancelPage1 = PageFactory.initElements(driver, CancelTransaction.class);
            Thread.sleep(1000);
            cancelPage1.clickCancelTransBtn();
            Thread.sleep(1000);
            CancelTransaction cancelPage2 = PageFactory.initElements(driver, CancelTransaction.class);
            Thread.sleep(1000);
            cancelPage2.clickConfirmCancelTransBtn();
            Thread.sleep(1000);
            CancelTransaction cancelPage3 = PageFactory.initElements(driver, CancelTransaction.class);
            Thread.sleep(1000);
            cancelPage3.inputReasonForCancel(reasonForCancel);
            Thread.sleep(1000);
            cancelPage3.clickConfirm();
            Thread.sleep(8000);
            CancelTransaction cancelPage4 = PageFactory.initElements(driver, CancelTransaction.class);

            if (cancelPage4.checkConfirmResp().equals("ยกเลิกรายการสำเร็จ")) {
                dataProvider.setOutputData("#output", "ยกเลิกรายการสำเร็จ");
            } else {
                dataProvider.setOutputData("#output", "ยกเลิกรายการไม่สำเร็จ");
            }
            Thread.sleep(5000);
            cancelPage4.clickConfirmResp();
