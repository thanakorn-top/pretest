...
//            loginpage.setId("KussakornA");
            ...
            if (!cancelPage3.checkResponseVerifyReasonForCancel().equals("")) {
                dataProvider.setOutputData("#output", cancelPage3.checkResponseVerifyReasonForCancel());
            } else {
                dataProvider.setOutputData("#output", "");
            }
            Thread.sleep(1000);
            cancelPage3.clickCancelReasonConfirm();
            Thread.sleep(1000);
//            dataProvider.setOutputData("#output", "");
            Thread.sleep(5000);
