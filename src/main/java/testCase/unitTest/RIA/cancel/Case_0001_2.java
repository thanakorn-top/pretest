...
//            loginpage.setId("KussakornA");
            ...
            String errResp = cancelPage1.getErrorDialog();
            Thread.sleep(2000);
            if (errResp.equals("ไม่พบรหัสรับเงินในระบบ")) {
                dataProvider.setOutputData("#output", errResp);
            } else {
                dataProvider.setOutputData("#output", "");
            }
            cancelPage1.clickCancelErrorDialog();
            Thread.sleep(5000);
